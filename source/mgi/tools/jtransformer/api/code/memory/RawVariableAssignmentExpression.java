...
public class RawVariableAssignmentExpression extends ExpressionNode {
	...
	public RawVariableAssignmentExpression(Type variableType, int index, ExpressionNode expr) {
	...
	public ExpressionNode copy() {
		return new RawVariableAssignmentExpression(variableType, index,expression.copy());
	}
