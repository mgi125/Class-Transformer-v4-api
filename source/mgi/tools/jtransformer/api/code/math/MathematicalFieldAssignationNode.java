...
public class MathematicalFieldAssignationNode extends AbstractCodeNode {
	...
	public MathematicalFieldAssignationNode(ExpressionNode instanceExpression, ExpressionNode expression, int type, String owner, String name, String descriptor) {
	...
	public void accept(MethodVisitor visitor) {
		...
		switch (type) {
			case TYPE_ADD:
				opcode = Utilities.addOpcode(expression.getType());
				break;
			case TYPE_SUB:
				opcode = Utilities.subtractOpcode(expression.getType());
				break;
			case TYPE_MUL:
				opcode = Utilities.multiplyOpcode(expression.getType());
				break;
			case TYPE_DIV:
				opcode = Utilities.divideOpcode(expression.getType());
				break;
			case TYPE_REM:
				opcode = Utilities.remainderOpcode(expression.getType());
				break;
			case TYPE_SHL:
				opcode = Utilities.bitShiftLeftOpcode(expression.getType());
				break;
			case TYPE_SHR:
				opcode = Utilities.bitShiftRightOpcode(expression.getType());
				break;
			case TYPE_USHR:
				opcode = Utilities.bitShiftRightUnsignedOpcode(expression.getType());
				break;
			case TYPE_OR:
				opcode = Utilities.bitOrOpcode(expression.getType());
				break;
			case TYPE_AND:
				opcode = Utilities.bitAndOpcode(expression.getType());
				break;
			case TYPE_XOR:
				opcode = Utilities.bitXorOpcode(expression.getType());
				break;
			default:
				throw new RuntimeException("WT");
		}
