...
public class UnconditionalJumpNode extends AbstractCodeNode {
	...
	public UnconditionalJumpNode(LabelAnnotation target) {
		this.target = target;
	}
	...
	public void print(CodePrinter printer) {
		printer.print("GOTO\tl_" + target.getLabel().hashCode());
	}
