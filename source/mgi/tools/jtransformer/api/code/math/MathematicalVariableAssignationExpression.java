...
public class MathematicalVariableAssignationExpression extends ExpressionNode {
	...
	public MathematicalVariableAssignationExpression(Type variableType, int operationType, int index, ExpressionNode expression) {
	...
	public ExpressionNode copy() {
		return new MathematicalVariableAssignationExpression(variableType, operationType, index, expression.copy());
	}
	...
	public void accept(MethodVisitor visitor) {
		...
		visitor.visitInsn(Utilities.dupOpcode(variableType));
		visitor.visitVarInsn(Utilities.variableStoreOpcode(variableType), index);
	}

	@Override
	public void print(CodePrinter printer) {
		if (isPlusMinusPrefix()) {
			printer.print((operationType == TYPE_ADD ? "++" : "--") + "var_" + index);
		}
		else {
