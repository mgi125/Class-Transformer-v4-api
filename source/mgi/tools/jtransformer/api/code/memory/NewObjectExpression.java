...
public class NewObjectExpression extends ExpressionNode {
	...
	public NewObjectExpression(Type type, ExpressionNode[] arguments, String owner, String descriptor) {
		this.type = type;
	...
	public ExpressionNode copy() {
		...
		return new NewObjectExpression(type, arguments, owner, descriptor);
	}
